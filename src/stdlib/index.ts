...
export function registerStdlib(scope: Scope) {
    const registerModule = (name: string, tasks: Record<string, NativeFunc>) => {
        ...
        scope.set(name, { type: ValueType.Object, value: moduleObj });
    };
